...
function crearChecklistLineaAmarilla() {
    return crearChecklist([
        ...
        "Radiador (Nivel de liquido, estado de ventilador, control de fugas)",
        "*Dirección (Nivel de fluido, estado de botellas hidráulicas, estado y ajuste de terminales, control de fugas)",
        "Tanques de combustible (Estado de Abrazaderas y Soportes, control de fugas)",
        "Tanque hidráulico (Nivel de aceite, estado de abrazaderas y soportes, control de fugas)",
        "Baterías (Estado de Bornes y cables)",
        "Exosto (Estado de Soportes y control de escapes)",
        "*Llantas (Estado de labrado, presión de inflado, pernos completos y ajustados)",
        "*Luces (Frontales (altas y bajas), traseras, direccionales  y del parqueo delanteras, direccionales  y del parqueo traseras, de alarma de reversa, de cabina)",
        "*Frenos (de Servicio y Parada o emergencia, control de fugas)",
        "Mandos de movimientos (mecanismos de articulación, cuchilla e implementos, marcha y contramarcha, levante del equipo, timón, pedales)",
        "Estado hoja vertedera",
        "Estado giro circulo",
        "Estado de la barra de tiro",
        "Cilindros hidráulicos en buen estado",
        "Estado de la transmisión",
        "Ripper (Estado y ajuste)",
        "Herramienta de  trabajo (Escarificadores, cuchillas, cucharon, hoja topadora, cucharon, cilindro, pala desgarrador, balde, almeja)",
        "Escaleras y pasamanos cabina",
        "*Espejos retrovisores laterales y central cabina",
        ...
        "Oruga(estado de zapatas y cadenas, tensión)",
        "Mecanismo de bloque de mandos",
        "Corona tornamesa (Ajuste y control de fugas)",
        "Fugas hidráulicas",
        "Estado pasadores",
        "Mecanismo de giro y ecualización cuba (tolva)",
        "Manguera de agua y alta presión",
        "Dispositivo de agua",
        "Bastidor conexión armazón soporte",
        "**Cabina antivuelco y hermética (R.O.P.S)",
        "**Vidrio panorámico de seguridad laminado",
        "*Tablero de Instrumentos  (Estado y funcionamiento de indicadores)",
        "Timón (Estado y ajuste, control de graduación y seguro)",
        "Cierre y Bloqueo de puertas cabina",
        "Estado y cierre de puertas laterales motor",
        "Radio FM (Estado de Antena)",
        "Aire Acondicionado",
        "Latonería y pintura cabina",
        "**Cinta reflectiva",
        "Equipo de prevención y seguridad (Botiquín Prim. Auxilios, Extintor de Incendios, Kit Ambiental)",
        "Desinfección interna(rociar alcohol sobre toda superficie, plástica o metálica donde pueda apoyarse las manos al subir, bajar, acomodarse dentro del habitáculo o durante el transporte, repasar con paños húmedos las puertas, apoya brazos y otros puntos de agarre normal)"
    ]);
}
...
function crearChecklistLineaBlanca() {
    return crearChecklist([
       "Documentos (Licencia de tránsito, SOAT, Revisión Tecnicomecánica)",
        "Tarjeta de Operación y Extracto de Contrato para Servicio Público",
        "Certificado de Prueba hidrostática para Carrotanques de Combustible",
        "Motor (Nivel de fluido, estado de soportes y correas, control de fugas)",
        "Radiador (Nivel de líquido, estado de ventilador, control de fugas)",
        "* Dirección (Nivel de fluido, estado de terminales, Alineación y control de fugas)",
        "Tanques de combustible (Estado de Abrazaderas y Soportes)",
        "Tanque hidraulico (Nivel de aceite, estado abrazadera y soportes, control de fugas tanque y mangueras)",
        "Baterías (Estado de Bornes y cables)",
        "Exosto (Estado de Soportes y control de escapes)",
        "Suspensión (Estado de resortes, grapas  y amortiguadores)",
        "Transmisión (Estado de cardan y crucetas, Cadena seguridad del Cardan, control de fugas)",
        "Chasís (Estado de guardapolvos)",
        "Carroceria (Estado de las tablas y cierre de compuertas)",
        "* Llantas (Estado de labrado, presión de inflado, pernos completos y ajustados)",
        "* Luces (Frontales, Direccionales y del parqueo delanteras, Direccionales y del parqueo traseras, de frenado, de alarma de reversa, laterales y de cabina)",
        "* Frenos (de Servicio y Parada o emergencia, control de fugas)",
        "Estribos cabina, escaleras y pasamanos",
        "Mangueras neumáticas y acoples del trailer",
        "Quinta rueda(estado de tornillos y ajuste)",
        "Volco y compuerta (corrosión, fisuras, ajuste pasadores)",
        "Sistema de levante volco (Gato hidráulico, control de fugas por mangueras)",
        ...
        "Kit para atención de Derrames (Tanque con Combustible)",
        "Hoja de seguridad y tarjeta de emergencia de ACPM",
        "* Espejos (Retrovisores laterales y central cabina)",
        "** Silla con apoyacabezas (Estado y ajuste de amortiguacion y tapicería)",
        "** Cinturones de seguridad",
        ...
        "* Tablero de Instrumentos (Estado y funcionamiento de indicadores)",
        "* Airbag",
        "Cierre y Bloqueo de puertas",
        "Radio FM (Estado de Antena)",
        "Aire Acondicionado",
        "Latonería y pintura cabina",
        "Amarres(Cadenas, tensores, bandas)",
        "Platón (Corrosión, fisuras, ajuste)",
        "Barra antivolco",
        "Letreros y señalización(Estado rotulos)",
        "** Cinta reflectiva",
        "Sistema de cierre de la Compuerta",
        "Kit de Carretera (Juego de llaves Mixtas, Alicate, Expansiva, Destornillador estría y pala, Gato 20 Ton, Copa pernos, Chaleco, Linterna, Botiquín de Primeros Auxilios, Extintor de Incendios, Conos reflectivos (2), Tacos rueda (2), llanta de Repuesto)",
        "Desinfección interna (rociar alcohol sobre toda superficie, plastica o metalica donde pueda apoyarse las manos al subir, bajar, acomodarse dentro del habitáculo o durante el transporte, repasar con paños húmedos las puertas, apoya brazos y otros puntos de agarre normal)"
    ]);
}
